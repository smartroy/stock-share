function add_item(){
    ...
    console.log(next);
    $("#itemtable").append(
                        '<tr id="item' + next + '" class="item"><td><input type="text" name="upc"></td><td><input type="text" size="10" name="brand"></td><td><input type="text" size="10" name="name"></td><td><input type="text" size="10" name="type"></td><td><input type="text" size="10" name="getprice"></td><td><input type="text" size="10" name="sellprice"></td><td><input type="text" size="10" name="qty"></td><td><button type="button" id="remove' + next + '" onclick="remove_item(this.id)">-</button></tr>'
        );
